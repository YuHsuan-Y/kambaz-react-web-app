    ...
    return(
        <div id="wd-css-grid-layout">
            ...
            <div id="wd-css-left-third-right-two-thirds" className="wd-grid-row">
                ...
                <div className="wd-grid-col-two-thirds-page wd-bg-color-red
                        wd-fg-color-white">
            ...
            <div id="wd-css-side-bars" className="wd-grid-row">
                ...
                <div className="wd-grid-col-main-content wd-bg-color-blue
                        wd-fg-color-white">
                    <h3>Main content</h3>
                    <p>This is the main content. This is the main content. This is the main content.</p>
                </div>

                <div className="wd-grid-col-right-sidebar wd-bg-color-green
                    wd-fg-color-white">
                        <h3>Side bar</h3>
